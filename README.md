...
3.) If using Gradle, go to the *build.gradle* file and add the following line *Note: Make sure to click the 'import changes' pop-up that shows up when using IntelliJ*
